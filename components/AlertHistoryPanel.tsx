...
export const AlertHistoryPanel: React.FC<AlertHistoryPanelProps> = ({ isOpen, onClose, alerts, onClear }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end sm:justify-center sm:items-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div className="relative bg-white w-full sm:max-w-md h-[70vh] sm:h-[600px] sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom duration-300">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gray-50">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-gray-800">Nhật ký Cảnh báo</h3>
              <p className="text-xs text-gray-500">{alerts.length} thông báo</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button 
            ...
            alerts.map((alert) => (
              <div key={alert.id} className="flex flex-col animate-in slide-in-from-left-2 duration-300">
                ...
                <div className="flex items-center gap-2 mb-1 pl-2">
                    <span className="text-[10px] font-bold text-gray-400 bg-gray-200 px-1.5 py-0.5 rounded flex items-center gap-1">
